...
import {Slider, Checkbox, StepLabel, Step, Stepper,TextField,RadioGroup,Radio,FormGroup,FormControlLabel,Select,Paper,IconButton,List,InputLabel,Tooltip,ListItem,Typography,FormControl,ListItemText,Divider,Grid,Button} from '@material-ui/core/';
            ...
            <Grid container item xs={12} direction="row" justify="center" style={{marginTop:10}} >
                <Grid item sm={6} xs={12}>
                    ...
                    <FormControl variant="outlined" style={{minWidth:350}}>
                        <InputLabel htmlFor="outlined-age-native-simple">Objetivo Desarrollo Sostenible</InputLabel>
                        <Select
                        native
                        label="ODS"
                        inputProps={{
             ...
             <Grid item xs={12} > 
                ...
                <Grid container  item direction="row" justify="space-between"> 
                    ...
                    <Button variant="contained" style={{marginBottom:10}} size="small" color="primary">
                        Crear
                    </Button>
                </Grid>   
    ...
    return(
        <div>
            <Grid container direction="row" justify="center" alignItems="center" spacing={3}>
                ...
                <Grid  item container sm={4} xs={12} direction="column" justify="center" style={{marginTop:10}}>
                    <Grid item  xs={12}>
                        <TextField style={{minWidth:250}} id="NombreEvento" label="Nombre Evento" variant="outlined"/>
                    </Grid>
                    <Grid item xs={12}>
                        <TextField style={{minWidth:250}} id="competencia" label="Competencia" variant="outlined"/>
                    </Grid>
                    <Grid item xs={12}>
                        <Typography style={{ textAlign: 'left'}} variant={"h6"} color="primary" display="block" >Dimensión</Typography>
                        <FormGroup row>
                ...
                <Grid  item container sm={4} xs={12}  direction="column" justify="center" style={{marginTop:40}}>
                    <Grid container  item direction="row" justify="space-between"> 
                        <Typography  variant={"h6"} color="primary" display="block" >Metas</Typography>
                        <Button variant="contained" style={{marginBottom:10}} size="small" color="primary">
                            Crear
